  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          World-Class Tutoring, Wherever You Learn Best
        </h2>
        ...
        <div
          style={{
            ...
            gap: 32,
            maxWidth: 900, // Constrained slightly so the two cards aren't overly stretched
            margin: "0 auto",
          }}
        >
          {pricingPlans.map((plan, i) => (
            ...
            >
              ...
              <ul style={{ padding: 0, margin: "0 0 40px 0", listStyle: "none", display: "flex", flexDirection: "column", gap: 16 }}>
                {plan.features.map((feature, index) => (
                  <li key={index} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: COLORS.navy, lineHeight: 1.5 }}>
                      {feature}
                    </span>
                  </li>
                ))}
              ...
              {/* Locations Note (Only renders if it exists) */}
              {plan.locations && (
                <div style={{ marginTop: "auto", marginBottom: 24 }}>
                  <p style={{
                    ...
                    lineHeight: 1.5,
                    padding: "16px",
                    background: "rgba(201,151,58,0.05)", // Very subtle gold tint
                    borderRadius: 8,
                  }}>
