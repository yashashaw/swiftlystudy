  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", position: "relative" }}>
        ...
        >
          Ready to unlock your potential? Reach out and we'll match you with the
          perfect tutor.
        </p>
        ...
        {sent ? (
          ...
          >
            ...
            >
              We'll get back to you within 24 hours to set up your first
              session.
            </p>
          </div>
        ) : (
          ...
          >
            ...
            >
              {[
                ...
                { key: "email", placeholder: "your@email.com", label: "Email" },
              ].map((f) => (
                <div key={f.key}>
            ...
            <button
              ...
              onMouseOut={(e) => {
                ...
                e.target.style.boxShadow = "0 4px 24px rgba(201,151,58,0.35)";
              }}
            >
              Send Message
            </button>
